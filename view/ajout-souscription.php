<?php
	...
	require_once '../model/ajout-souscription.php';
		...
		<div class="panel-body">
			<form method="post" action="" enctype="multipart/form-data">
				<div class="form-group">
					...
					<input type="text"  id="abonne_name" name="code_abonne" class="form-control">
				</div>
				<div class="form-group">
					<label class="control-label">
						TYPE ABONNEMENT:
					</label>
					<input type="text" name="num_abon" id="toto" class="form-control">
