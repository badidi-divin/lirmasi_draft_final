		...
		<div class="panel-body">
			<form method="post" action="" enctype="multipart/form-data">
				<div class="form-group">
					...
					<input type="text" name="designation" required="required" class="form-control" placeholder="Entrer la designation" value="<?= $userinfo['designation']; ?>">
				</div>
			  <div class="form-group">
					<label class="control-label">
						Prix($):
			  ...
			  <div class="form-group">
					...
					<input type="number" name="qte_stock" required="required" class="form-control" placeholder="Entrer la quantité en stock" value="<?= $userinfo['qte_stock']; ?>">
			  </div>
			   <div class="form-group">
					<label class="control-label">
						Catégorie:
